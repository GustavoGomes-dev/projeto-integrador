...
formCadastro.addEventListener("submit", function (event) {
  ...
  fetch("https://codegame-ctajahh4gpfbchhc.brazilsouth-01.azurewebsites.net/catalogo/adicionar", {
    method: "POST",
    headers: {
...
function carregarJogos() {
  fetch("https://codegame-ctajahh4gpfbchhc.brazilsouth-01.azurewebsites.net/catalogo/listar", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
excluir.addEventListener("click", function () {
  if (jogoIdParaExcluir) {
    fetch(`https://codegame-ctajahh4gpfbchhc.brazilsouth-01.azurewebsites.net/catalogo/${jogoIdParaExcluir}`, {
      method: "DELETE",
    })
      .then((response) => {
        if (!response.ok) {
...
const closeModal = document.getElementById("closeModalAlterar");
  ...
  document.getElementById("formAlterar").addEventListener("submit", function (event) {
    ...
    fetch(`https://codegame-ctajahh4gpfbchhc.brazilsouth-01.azurewebsites.net/catalogo/${jogoIdParaAlterar}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
...
function buscarJogoPorNome(nome) {
  fetch(`https://codegame-ctajahh4gpfbchhc.brazilsouth-01.azurewebsites.net/catalogo/buscar?nome=${nome}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
